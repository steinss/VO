...
namespace slam_g2o
{
void EdgeXYZ2UV::computeError()
{
    const g2o::VertexSE3Expmap* v1 = static_cast<const g2o::VertexSE3Expmap*>(_vertices[0]);
    _error = _measurement-cameraa_->camera2pixel(v1->estimate().map(point_));
}
void EdgeXYZ2UV::linearizeOplus()
{
    ...
    _jacobianOplusXi ( 0,0 ) = x*y/z_2 *cameraa_->fx_;
    _jacobianOplusXi ( 0,1 ) = - ( 1+ ( x*x/z_2 ) ) *cameraa_->fx_;
    _jacobianOplusXi ( 0,2 ) = y/z * cameraa_->fx_;
    _jacobianOplusXi ( 0,3 ) = -1./z * cameraa_->fx_;
    _jacobianOplusXi ( 0,4 ) = 0;
    _jacobianOplusXi ( 0,5 ) = x/z_2 * cameraa_->fx_;

    _jacobianOplusXi ( 1,0 ) = ( 1+y*y/z_2 ) *cameraa_->fy_;
    _jacobianOplusXi ( 1,1 ) = -x*y/z_2 *cameraa_->fy_;
    _jacobianOplusXi ( 1,2 ) = -x/z *cameraa_->fy_;
    _jacobianOplusXi ( 1,3 ) = 0;
    _jacobianOplusXi ( 1,4 ) = -1./z *cameraa_->fy_;
    _jacobianOplusXi ( 1,5 ) = y/z_2 *cameraa_->fy_;
}
